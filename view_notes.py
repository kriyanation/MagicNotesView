...
class MagicNotesPrint(tk.Frame):
    def __init__(self,parent,*args,**kwargs):
        ...
        self.notes_file = file_root+os.path.sep+"Lessons"+os.path.sep+"Lesson"+str(self.lesson_id)+os.path.sep+"papers"+os.path.sep+"notes_"+str(self.lesson_id)+".pdf"
        ...
        try:
            if sys.platform == "win32":
                ...
                subprocess.call([opener, self.notes_file])
        except:
...
if __name__== "__main__":
    ...
    frame = MagicNotesPrint(dashboard_app)
